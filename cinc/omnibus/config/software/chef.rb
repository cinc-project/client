...
build do
  ...
  command "echo \"74: $(ls #{install_dir}/embedded/lib/chef-zero/*\" || echo 'Not yet'"
  ...
  command "echo \"79: $(ls #{install_dir}/embedded/lib/chef-zero/*\" || echo 'Not yet'"
  ...
  command "echo \"83: $(ls #{install_dir}/embedded/lib/chef-zero/*\" || echo 'Not yet'"
