...
build do
  ...
  gem 'specific_install -l https://github.com/cc-build/chef-zero.git -b brand_refactor', { environment: {GEM_HOME: "#{install_dir}/embedded", GEM_PATH: "#{install_dir}/embedded"} } 
